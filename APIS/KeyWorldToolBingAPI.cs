...
namespace APIS
{
    public class KeyWorldToolBingAPI
    {
        private static readonly String apikey = "[API_KEY]";

        private static readonly String apiurl = "https://api.keywordtool.io/v2/search/volume/bing";

        private String apiparams;

        private void BuildParameters(string keyword)
        {
            apiparams = "apikey=" + apikey + "&keyword=[\""+ keyword + "\"]&metrics_location=190&metrics_language=English&metrics_network=ownedandoperatedandsyndicatedsearch&metrics_currency=USD&output=json";
        }
